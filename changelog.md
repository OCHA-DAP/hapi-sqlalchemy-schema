...
- Add ETT to IOM assessment type enum

## 0.9.15

### Fixed

- Propagate lat lon changes to food price views as tables

## 0.9.14

### Fixed

- Propagate appeal type and lat lon changes to views as tables

## 0.9.13

### Fixed

- Make appeal_type longer to match new FTS type names
