        ...
        *DBPopulation.__table__.columns,
        ...
        case(
            (
                or_(
                    and_(
                        DBPopulation.provider_admin2_name.is_not(None),
                        DBPopulation.provider_admin2_name != "",
                    ),
            ...
            (
                or_(
                    and_(
                        DBPopulation.provider_admin1_name.is_not(None),
                        DBPopulation.provider_admin1_name != "",
                    ),
