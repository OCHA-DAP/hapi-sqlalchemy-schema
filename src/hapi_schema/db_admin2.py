...
class DBAdmin2_vat(Base):
    ...
    admin1_reference_period_start: Mapped[datetime] = mapped_column(DateTime)
    admin1_reference_period_end: Mapped[datetime] = mapped_column(DateTime)
